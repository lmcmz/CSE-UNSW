...
def min_neighbor_8(img, x, y):
	...
	i1 = 0 if x==0 or y==0 else img[x - 1, y - 1]
	i2 = 0 if x==size_w-1 or y==0 else img[x + 1, y - 1]
	j1 = 0 if x==0 or y==size_h-1 else img[x - 1, y + 1]
	j2 = 0 if x==size_w-1 or y==size_h-1 else img[x + 1, y + 1]
